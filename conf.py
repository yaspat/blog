...
## AJOUT DE YAS : pris sur le site de la doc de Nikola


# !! This is the configuration of Nikola. !! #
# !!  You should edit it to your liking.  !! #`x
...
BLOG_AUTHOR = "M. Patel"  # (translatable)
BLOG_TITLE = "Mathématiques pythoniques pour Biwanes"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://yaspat.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://yaspat.github.io/blog/"
BLOG_EMAIL = "patel.bcpst@gmail.com"
BLOG_DESCRIPTION = "Cours de maths pour la classe de BCPST1-A de Rennes"  # (translatable)
...
# Barre de Naviagation pour le theme de Damian zen-ipython
# Les icones sont celles de la fonte : awesome-3-2.1. Les
# noms des icones sont dispos à  : http://fortawesome.github.io/Font-Awesome/3.2.1/icons/
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ('/index.html', 'Départ', 'icon-home'),
        ('/stories/about-me', 'Mathématiques pythoniques ?', 'icon-question-sign'), 
        
        #('/stories/programmes-de-colles','Colles','icon-calendar'),
        ('/stories/documents-de-travail', 'Documents','icon-file-text'), 
        ('/stories/informatique','Informatique','icon-desktop'),
        
        
        #('/stories/sujets-de-ds','DM/DS','icon-edit'),
        ('/stories/livre-dor',"Livre d'or",'icon-book'), 
        ('/archive.html', 'Archives', 'icon-archive'),
        ('/categories/index.html', 'Étiquettes', 'icon-tags'),
        ('https://twitter.com/yaspatmat', 'Twitter', 'icon-twitter'),
       ('https://github.com/yaspat', 'Github', 'icon-github'),
...
LICENSE = """
<a rel="license" href="http://creativecommons.org/licenses/by-nc-sa/2.5/deed.fr">
...
# (translatable)
CONTENT_FOOTER = """ <hr> Contenu &copy; {date}  <a href="mailto:{email}">{author}</a> -  Blog généré par  <a href="https://getnikola.com" rel="nofollow">Nikola</a>  -   Thème  : d\'après <a href="https://github.com/getnikola/nikola-themes/tree/master/v7/zen-ipython">zen-ipython</a> de <a href="http://www.damian.oquanta.info/index.html"> Damián Avila</a><br> {license}"""
