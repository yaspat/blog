...
J'ai enfin généré l'animation de  :math:`k=1` à :math:`k=9` par pas de :math:`1/10` pour voir l'évolution de la figure à mesure que $k$ augmente : 

+-------------+--------------------------+
|             | .. youtube:: iJnRFsCGkNA |
+-------------+--------------------------+ 

Pour savoir comment la fabriquer en *Python* allez voir `ici <link://slug/animation-en-python>`_.
